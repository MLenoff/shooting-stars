...
export const programs: Program[] = [
  ...
  // Training Packages (grouped under one card)
  {
    ...
    dates: 'Tuesday, Thursday & Friday',
    times: 'Tuesday, Thursday & Friday 4:30PM–5:25PM',
    price: 728.00,
    active: true,
    flyer: '/individual.avif',
  },
  ...
  // Birthday Party Packages
  {
    ...
    type: 'party',
    description: 'Birthday parties are Fridays, Saturdays and Sundays. After you've reached your limit of 20 kids, $12 per child will apply. Want to rent the other field? Add $80 per hour.',
  ...
  },
  {
    ...
    type: 'party',
    description: 'Birthday parties are Fridays, Saturdays and Sundays. After you've reached your limit of 20 kids, $12 per child will apply. Want to rent the other field? Add $80 per hour. The 12-3pm slot is Saturdays and Sundays only.',
    dates: 'Fridays, Saturdays & Sundays',
